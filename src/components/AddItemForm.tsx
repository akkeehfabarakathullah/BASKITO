...
import { Plus, Camera, X, Package, Tag, AlertCircle, DollarSign, Calendar, Leaf } from 'lucide-react';
...
export const AddItemForm: React.FC<AddItemFormProps> = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    dispatch({ type: 'ADD_TO_SEARCH_HISTORY', payload: name.trim() });
  ...
  const fillFromSuggestion = (suggestion: string) => {
    setName(suggestion);
    // Auto-fill common quantities and categories based on item name
    const lowerSuggestion = suggestion.toLowerCase();
    if (lowerSuggestion.includes('milk')) {
      setQuantity('1 liter');
      setCategory('Dairy');
      setEstimatedPrice('250');
    } else if (lowerSuggestion.includes('bread')) {
      setQuantity('1 loaf');
      setCategory('Bakery');
      setEstimatedPrice('120');
    } else if (lowerSuggestion.includes('banana')) {
      setQuantity('1 kg');
      setCategory('Fruits');
      setEstimatedPrice('180');
    }
  };
        ...
        <div className="p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="flex items-center space-x-3">
                ...
                >
                  ...
                  <span>{isCapturing ? 'Capturing...' : 'Add Photo'}</span>
                </button>
                {photo && (
            ...
            <div className="flex space-x-3 pt-6">
              ...
              <button
                type="submit"
                className="flex-1 py-4 px-4 bg-gradient-to-r from-emerald-500 to-green-500 text-white rounded-xl font-semibold hover:from-emerald-600 hover:to-green-600 transition-all duration-200 flex items-center justify-center space-x-2 shadow-lg shadow-emerald-500/25"
              >
